...
namespace NamedPipeWrapper
{
    ...
    {
        /// <summary>
        /// Constructs a new <c>NamedPipeClient</c> to connect to the <see cref="NamedPipeClient{TReadWrite}"/> specified by <paramref name="pipeName"/>.
        /// </summary>
        ...
        where TWrite : class
    {
        ...
        /// <summary>
        /// Invoked when the client connects from the server.
        /// </summary>
        ...
        private void OnConnected(NamedPipeConnection<TRead, TWrite> connection)
        {
            if (Connected != null)
